...
void PA_InitTiledBgBuffers(void);
...
void PA_InitTiledBgSys(u8 screen);
...
void PA_LoadTiledBg(const char* file, const char* name, u16 width, u16 height);
...
void PA_UnloadTiledBg(const char* name);
