...
#ifndef __PA_TEXT_H__
#define __PA_TEXT_H__
...
extern PA_TYPE_TEXT_IPAO PA_TEXT[2][4];		// Datos de las capas de texto



// Funcion PA_InitTextSys();
void NF_InitText(u8 screen);
...
// Esta funcion simplemente llama a PA_CreateTiledBg(); para su creacion
...
void PA_ClearTextBgSys(u8 screen, u8 layer);
